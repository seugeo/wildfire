...
DNA_NA_0_c_T3 <- DNA_NA_0.stats %>%
  filter(Habitat == "Chaparral"&TimePoint == "T3")
kruskal.test(DNA_g ~ Treatment, DNA_NA_0_c_T3)

DNA_NA_0_w_T3 <- DNA_NA_0.stats %>%
  filter(Habitat == "Woodland"&TimePoint == "T3")
kruskal.test(DNA_g ~ Treatment, DNA_NA_0_w_T3)

DNA_NA_0_c_T4 <- DNA_NA_0.stats %>%
  filter(Habitat == "Chaparral"&TimePoint == "T4")
kruskal.test(DNA_g ~ Treatment, DNA_NA_0_c_T4)

DNA_NA_0_w_T4 <- DNA_NA_0.stats %>%
  filter(Habitat == "Woodland"&TimePoint == "T4")
kruskal.test(DNA_g ~ Treatment, DNA_NA_0_w_T4)

DNA_NA_0_c_T5 <- DNA_NA_0.stats %>%
  filter(Habitat == "Chaparral"&TimePoint == "T5")
kruskal.test(DNA_g ~ Treatment, DNA_NA_0_c_T5)

DNA_NA_0_w_T5 <- DNA_NA_0.stats %>%
  filter(Habitat == "Woodland"&TimePoint == "T5")
kruskal.test(DNA_g ~ Treatment, DNA_NA_0_w_T5)
...
pca.w.nut.mtx <- as.data.frame(w.nut.mtx) %>%
  select(Moisture, SoilpH, OrganicMatter, Nitrate, InorganicPhosphorus, Calcium, Magnesium, Potassium, Sodium)
...
cb_Pbl <- cb_Pbl %>%
  mutate(NewHabitat = case_when(
    ...
    Habitat == "Forest_Heated30ºC" ~ "mixed conifer forest",
